  ...
  ,tf_(this)
{
  ...
  this->ports()->addPort("p_err_wrench_debug_out", p_err_wrench_debug_out_);
  p_err_wrench_debug_out_.createStream(rtt_roscomm::topic("~/"+this->getName()+"/p_err_wrench"));
  this->ports()->addPort("d_err_wrench_debug_out", d_err_wrench_debug_out_);
  d_err_wrench_debug_out_.createStream(rtt_roscomm::topic("~/"+this->getName()+"/d_err_wrench"));

  this->ports()->addPort("twist_debug_out", twist_debug_out_);
  twist_debug_out_.createStream(rtt_roscomm::topic("~/"+this->getName()+"/twist"));
...
void JTNullspaceController::updateHook()
{
  ...
  p_wrench_.segment<3>(0) = linear_p_gain_*p_err;
  p_wrench_.segment<3>(3) = angular_p_gain_*r_err;

  d_wrench_.segment<3>(0) = linear_d_gain_*v_err;
  d_wrench_.segment<3>(3) = angular_d_gain_*w_err;

  wrench_ = p_wrench_ + d_wrench_;
  ...
  // Debug visualization
  if(this->debug_throttle_.ready(0.02)) {
    wrench_msg_.header.frame_id = tip_link_;
    wrench_msg_.header.stamp = rtt_rosclock::host_now();
    KDL::Wrench tip_wrench = frame.Inverse()*KDL::Wrench(
        KDL::Vector(wrench_(0), wrench_(1), wrench_(2)),
        KDL::Vector(wrench_(3), wrench_(4), wrench_(5)));
    ...
    KDL::Wrench tip_p_wrench = frame.Inverse()*KDL::Wrench(
        KDL::Vector(p_wrench_(0), p_wrench_(1), p_wrench_(2)),
        KDL::Vector(p_wrench_(3), p_wrench_(4), p_wrench_(5)));
    wrench_msg_.wrench.force.x = tip_p_wrench(0);
    wrench_msg_.wrench.force.y = tip_p_wrench(1);
    wrench_msg_.wrench.force.z = tip_p_wrench(2);
    wrench_msg_.wrench.torque.x = tip_p_wrench(3);
    wrench_msg_.wrench.torque.y = tip_p_wrench(4);
    wrench_msg_.wrench.torque.z = tip_p_wrench(5);
    p_err_wrench_debug_out_.write(wrench_msg_);

    KDL::Wrench tip_d_wrench = frame.Inverse()*KDL::Wrench(
        KDL::Vector(d_wrench_(0), d_wrench_(1), d_wrench_(2)),
        KDL::Vector(d_wrench_(3), d_wrench_(4), d_wrench_(5)));
    wrench_msg_.wrench.force.x = tip_d_wrench(0);
    wrench_msg_.wrench.force.y = tip_d_wrench(1);
    wrench_msg_.wrench.force.z = tip_d_wrench(2);
    wrench_msg_.wrench.torque.x = tip_d_wrench(3);
    wrench_msg_.wrench.torque.y = tip_d_wrench(4);
    wrench_msg_.wrench.torque.z = tip_d_wrench(5);
    d_err_wrench_debug_out_.write(wrench_msg_);

    KDL::Twist tip_twist = frame.Inverse()*KDL::Twist(
        KDL::Vector(twist_(0), twist_(1), twist_(2)),
        KDL::Vector(twist_(3), twist_(4), twist_(5)));
    wrench_msg_.wrench.force.x = tip_twist(0);
    wrench_msg_.wrench.force.y = tip_twist(1);
    wrench_msg_.wrench.force.z = tip_twist(2);
    wrench_msg_.wrench.torque.x = tip_twist(3);
    wrench_msg_.wrench.torque.y = tip_twist(4);
    wrench_msg_.wrench.torque.z = tip_twist(5);
    twist_debug_out_.write(wrench_msg_);
